...
const RandomPosts = () => {
  ...
  const handleOpenMore = () => setIsOpen(!isOpen)

  return (
    <section className=' w-full h-fit pl-[165px] mt-16 pr-[165px] max-w-[1536px] flex flex-col'>
      <div className='w-full h-fit object-cover cursor-pointer'>
      ...
      <div className=' flex flex-col mt-16'>
        ...
        {isOpen && (
          <div className=' flex flex-col mt-6 gap-12 animate-flip-down animate-once animate-duration-700 animate-delay-300'>
            <RandomPostCard
              subtitle='Makeup'
              title='Sed dignissim quam nulla, at sodales elit venenatis at. In in  fringilla'
              paragraph='Donec eget leo laoreet, faucibus ante et, finibus orci. Nam pulvinar felis vel mi aliquam, vitae dapibus odio euismod. Cras bibendum nisi a interdum facilisis…..'
      ...
      <button
        className='bg-black mt-16 ml-auto mr-auto p-4 pl-12 pr-12 text-white text-medium rounded-full leading-5'
        onClick={handleOpenMore}
      >
        {!isOpen ? 'Load More' : 'Show Less'}
      </button>
    </section>
  )
}
